...
const ProfileRec = () => {
  ...
  const loadRec = useSelector((state) => state.recReducer.loadRec);
    ...
    <div>
      {loadRec ? (
        ...
        <div>
                ...
                <div className="card mb-3">
                  <div className="card-body">
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-9 text-secondary">
                        {recruteur && recruteur.email}
                      </div>
                    </div>
                    <hr />
                    <div className="row">
                      <div className="col-sm-3">
                        <h6 className="mb-0">matricule</h6>
                      </div>
                      <div className="col-sm-9 text-secondary">
                        {recruteur && recruteur.matricule}
                      </div>
                    </div>
                    <hr />
                  </div>
          ...
          >
            {recruteur &&
              recruteur.offres.map((offre, id) => (
                <OffreCard offre={offre} key={id} />
              ))}
          </div>
        </div>
      )}
